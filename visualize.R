...
hist_sat=ggplot(project, aes(x=Satisfaction)) + geom_histogram(stat="count",bins=50,color="black", fill="black")
hist_sat
...
airlinestat_sat_box=ggplot(project,aes(x=Airline.Status,y=Satisfaction))+geom_boxplot()
airlinestat_sat_box
